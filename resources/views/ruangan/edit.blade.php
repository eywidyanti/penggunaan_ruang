		...
		<div class="main-panel">
			<div class="content">
				<div class="container-fluid">
					...
					<h4 class="ml-3">Edit Ruangan</h4>
					<div class="container">
							<div class="row">
								<div class="col-9"></div>
						<form action="{{url('ruangans/'.$ruangan->id)}}" method="POST">
							@method('PATCH')
							@csrf
							<div class="form-group ml-5">
								<label for="nama_ruang" class="col-form-label">Nama Ruangan</label>
								<div class="">
									<input type="text" class="form-control @error('nama_ruang') is-invalid @enderror" id="nama_ruang" name="nama_ruang" value="{{ old('nama_ruang') ?? $ruangan->nama_ruang}}">
									@error('nama_ruang')
