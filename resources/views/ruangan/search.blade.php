            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="row row-card-no-pd mt-4">
                        <h4 class="ml-3">Pencarian Ruangan</h4>
                        ...
                        <div class="container">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
										<div>
											<a href="{{url('/ruangans/'.$result->id.'/edit')}}" class="btn btn-primary">
												<i class="la la-edit"></i></a>
											<form action="{{url('/ruangans/'.$result->id)}}" method="POST" onclick="return confirm('Yakin hapus data?')">
												@method('DELETE')
