                        ...
                        <div class="container">
                            ...
                            <tbody>
                                ...
                                <tr>
										...
										<td>{{$result->role}}</td>
										<td>
											<img src="{{asset('img')}}/{{$result->foto}}" alt="" width="100px">
										</td>
										<td>{{$result->telp}}</td>
										<td>
											<div>
												<a href="{{url('/users/'.$result->id.'/edit')}}" class="btn btn-primary">
													<i class="la la-edit"></i></a>
												<form action="{{url('/users/'.$result->id)}}" method="POST" onclick="return confirm('Yakin hapus data?')">
													@method('DELETE')
