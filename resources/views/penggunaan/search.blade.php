                            ...
                            <table class="table table-striped ml-5 mr-5 mt-3">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$result->jam_keluar}}</td>
                                        <td>{{$result->ruang}}</td>
                                        <td class="text-center">
                                            @if($result->status == 'Kembalikan')
                                            <a href="{{url('/penggunaans/'.$result->id.'/edit')}}">
                                                <button class="btn-primary">{{$result->status}}</button> </a>
                                        </td>
                                        @else
                                        <button class="btn-danger">{{$result->status}}</button>
                                        @endif
                                        <td>
                                            <form action="{{url('/penggunaans/'.$result->id)}}" method="POST" onclick="return confirm('Yakin hapus data?')">
                                                @method('DELETE')
